...
Refer to the Python SDK's <a href="https://github.com/rudderlabs/rudder-sdk-python">GitHub repository</a> for the source code and implementation details.
</div>
...
For more information on the <code class="inline-code">alias</code> call, refer to the [**RudderStack Events Specification**](https://rudderstack.com/docs/rudderstack-api/api-specification/rudderstack-spec/alias/) guide.
</div>
