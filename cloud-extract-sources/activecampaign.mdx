...
This guide will help you set up ActiveCampaign as a source in RudderStack. Once configured, RudderStack automatically ingests your specified ActiveCampaign data and routes that data to the supported [**warehouse destinations**](https://rudderstack.com/docs/data-warehouse-integrations/).
...
<img src="../assets/cloud-extract-sources/activecampaign-1.png" alt="RudderStack Dashboard" />
...
<div class="successBlock">
  ...
  If you've already configured ActiveCampaign as a source before, you can choose the account visible under the <strong>Use existing credentials</strong> tab.
</div>
...
<div class="successBlock">
  ...
  Use the <strong>Connect Destinations</strong> option if you have already configured a data warehouse destination in RudderStack. To configure a data warehouse destination from scratch, click on the <strong>Add Destination</strong> button.
</div>
