...
<img src="../../../assets/event-stream-destinations/adobe-analytics-mobile-1.png" src="Manage App settings" />

- Click on the **Config File** option present at the bottom of the same page, as shown:

<img src="../../../assets/event-stream-destinations/adobe-analytics-mobile-2.png" src="Config file option" />
