...
<img src="../../assets/event-stream-destinations/ga4-connection-settings-1.png" alt="Google Analytics 4 connection settings" /><span class="imageTitle">Google Analytics 4 connection settings in RudderStack</span>
