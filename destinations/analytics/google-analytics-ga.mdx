...
<img src="../../assets/event-stream-destinations/ga-connection-settings-1.png" alt="Google Analytics connection settings" />

<img src="../../assets/event-stream-destinations/ga-connection-settings-2.png" alt="Google Analytics connection settings" />

<img src="../../assets/event-stream-destinations/ga-connection-settings-3.png" alt="Google Analytics connection settings" />
...
<img src="../../assets/event-stream-destinations/ga-custom-dimensions-settings.png" alt="Google Analytics custom dimensions and metrics settings" /><span class="imageTitle">Custom Dimensions and Metrics settings in RudderStack</span>

<img src="../../assets/event-stream-destinations/ga-custom-dimensions.png" alt="Google Analytics custom dimensions" /><span class="imageTitle">Custom Dimensions settings in Google Analytics</span>
...
<img src="../../assets/event-stream-destinations/ga-admin-interface.png" alt="Google Analytics E-commerce setup in admin dashboard" />
...
<img src="../../assets/event-stream-destinations/ga-site-search-tracking.png" alt="Google Analytics site search tracking settings" />
...
<img src="../../assets/event-stream-destinations/ga-property-mapping.png" alt="Google Analytics property mapping" /><span class="imageTitle">Content Group mapping in RudderStack</span>

<img src="../../assets/event-stream-destinations/ga-content-grouping.png" alt="Google Analytics content grouping settings" /><span class="imageTitle">Content Grouping settings in Google Analytics</span>
...
<img src="../../assets/event-stream-destinations/ga-property-setup.png" alt="Google Analytics property setup" /><span class="imageTitle">Changing the website URL from HTTP to HTTPS</span>
...
<img src="../../assets/event-stream-destinations/ga-realtime-reports.png" alt="Google Analytics realtime reporting" /><span class="imageTitle">Real-time event data report</span>
